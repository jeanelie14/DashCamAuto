# Script PowerShell pour tester sans Reanimated
Write-Host "🧪 Test sans Reanimated" -ForegroundColor Green
...
Write-Host "3. Installation sans Reanimated..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Si ça fonctionne, on pourra réajouter Reanimated plus tard" -ForegroundColor Yellow
