# Script PowerShell pour tester la configuration finale
Write-Host "🎯 Test configuration finale - VisionCamera 2.15.0" -ForegroundColor Green
...
Write-Host "3. Installation VisionCamera 2.15.0..." -ForegroundColor Yellow
npm install --legacy-peer-deps --force

# Nettoyer et rebuilder Android
Write-Host "4. Reconstruction Android avec configuration finale..." -ForegroundColor Yellow
Set-Location "android"
& ".\gradlew.bat" clean
& ".\gradlew.bat" assembleDebug
Set-Location ".."

Write-Host "✅ Test configuration finale terminé !" -ForegroundColor Green
Write-Host ""
