# Script PowerShell pour tester la Solution 4 - VisionCamera 3.0.0
Write-Host "🧪 Test Solution 4 - VisionCamera 3.0.0 compatible" -ForegroundColor Green
...
Write-Host "3. Installation VisionCamera 3.0.0..." -ForegroundColor Yellow
npm install --legacy-peer-deps --force

# Nettoyer et rebuilder Android
Write-Host "4. Reconstruction Android avec VisionCamera 3.0.0..." -ForegroundColor Yellow
Set-Location "android"
& ".\gradlew.bat" clean
& ".\gradlew.bat" assembleDebug
Set-Location ".."

Write-Host "✅ Test Solution 4 terminé !" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "Si ça ne fonctionne pas, on passera à la Solution 5" -ForegroundColor Yellow
