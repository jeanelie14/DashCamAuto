# Script PowerShell pour tester la Solution 5 - VisionCamera 2.16.1
Write-Host "🧪 Test Solution 5 - VisionCamera 2.16.1 compatible" -ForegroundColor Green
...
Write-Host "3. Installation VisionCamera 2.16.1..." -ForegroundColor Yellow
npm install --legacy-peer-deps --force

# Nettoyer et rebuilder Android
Write-Host "4. Reconstruction Android avec VisionCamera 2.16.1..." -ForegroundColor Yellow
Set-Location "android"
& ".\gradlew.bat" clean
& ".\gradlew.bat" assembleDebug
Set-Location ".."

Write-Host "✅ Test Solution 5 terminé !" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "Si ça ne fonctionne pas, on passera à la Solution 6" -ForegroundColor Yellow
