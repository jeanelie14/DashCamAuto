# Script PowerShell pour tester VisionCamera 2.13.0
Write-Host "🎯 Test VisionCamera 2.13.0 - Version plus ancienne" -ForegroundColor Green
...
Write-Host "3. Installation VisionCamera 2.13.0..." -ForegroundColor Yellow
npm install --legacy-peer-deps --force

# Nettoyer et rebuilder Android
Write-Host "4. Reconstruction Android avec VisionCamera 2.13.0..." -ForegroundColor Yellow
Set-Location "android"
& ".\gradlew.bat" clean
& ".\gradlew.bat" assembleDebug
Set-Location ".."

Write-Host "✅ Test VisionCamera 2.13.0 terminé !" -ForegroundColor Green
Write-Host ""
