# Script PowerShell pour tester la Solution 2 - Versions compatibles
Write-Host "🧪 Test Solution 2 - Versions compatibles officielles" -ForegroundColor Green
...
Write-Host "3. Installation des versions compatibles..." -ForegroundColor Yellow
npm install --legacy-peer-deps --force

# Nettoyer et rebuilder Android
Write-Host "4. Reconstruction Android avec versions compatibles..." -ForegroundColor Yellow
Set-Location "android"
& ".\gradlew.bat" clean
& ".\gradlew.bat" assembleDebug
Set-Location ".."

Write-Host "✅ Test Solution 2 terminé !" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "Si ça ne fonctionne pas, on passera à la Solution 3" -ForegroundColor Yellow
